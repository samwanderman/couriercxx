...
const uint8_t DISCOVERY_REQUEST[]		= { 0x44, 0x44, 0x43, 0x60, 0x09, 0x07, 0xa1, 0x43, 0x94, 0x3b, 0x28, 0xe2, 0xab, 0x08, 0x05, 0xee, 0xf2, 0xcd, 0xe1 };
const uint16_t DISCOVERY_REQUEST_SIZE	= 19;
const uint8_t DISCOVERY_RESPONSE[]		= { 0x44, 0x44, 0x52, 0xD1, 0x3A, 0xDE, 0x50, 0xFE, 0x28, 0x44, 0x1B, 0x19, 0x2F, 0x78, 0x1F, 0x7A, 0xE1, 0x85, 0x3F };
const uint16_t DISCOVERY_RESPONSE_SIZE	= 19;
